...
will generate red and blue points to form a flower. 
And will then fit a neural network to correctly classify the points. 
cx
...
X,Y = load_planar_dataset() # export data set
